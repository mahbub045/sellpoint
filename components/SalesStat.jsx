...
const SalesStat = () => {
    ...
    const [revenueData, setRevenueData] = useState([]); // Initialize with an empty array
    ...
    useEffect(() => {
        ...
        const dummyData = {
            '2020': [95, 85, 80, 100, 75, 80, 90, 50, 95, 80, 105, 110],
            '2021': [65, 59, 80, 81, 56, 55, 40, 70, 75, 110, 95, 120],
            '2022': [75, 95, 60, 85, 75, 60, 80, 85, 90, 75, 100, 110],
            '2023': [60, 65, 100, 85, 80, 85, 75, 80, 100, 90, 110, 115],
        };
    ...
    useEffect(() => {
        ...
        const dummyData = {
            ...
            '2023': [65, 59, 80, 81, 56, 55, 95, 70, 75, 110, 95, 120]
        };
        setRevenueData(dummyData[selectedYear]);
    }, [selectedYear]);
