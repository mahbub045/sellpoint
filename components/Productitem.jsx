  ...
  return (
    <>
      <Link legacyBehavior href={`/product/${product.slug}`}>
        <div
          className="card bg-slate-200 dark:bg-slate-950 rounded-md h-fit group cursor-pointer relative"
          title="View Details"
        >
          ...
          <div className="relative">
            ...
            <div className="absolute top-2 left-2 bg-emerald-500 rounded-md p-1 shadow-md">
              <p className="font-bold text-xs ">-{discount && discount}%</p>
            </div>
          </div>
          {/* Product details */}
          <div className="flex flex-col items-start justify-center px-3 py-2">
            <h2 className="font-medium dark:text-white line-clamp-1">
              {product.name}
            </h2>
            <p className="mb-1 text-sm text-gray-700 dark:text-gray-600">
              {product.brand}
            </p>
