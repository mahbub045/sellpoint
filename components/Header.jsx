...
//                                         <form
//                                             action=""
//                                             className="flex w-40 h-9 border border-emerald-400 rounded ml-2"
//                                         >
//                                             <input
//                                                 style={{ '--tw-ring-inset': 'none' }}
//                                                 type="text"
//                                                 className="block w-full px-3 text-black border-none ring-none rounded"
//                                                 placeholder='Search...'
//                                             />
//                                         </form>
//                                     )}
...
//                             {/* cart */}
//                             <div>
//                                 <a className="p-4 cursor-pointer text-white hover:text-stone-300" onClick={openCartModal}>
