  ...
  return (
    <footer className="bg-gray-800 text-white p-5 mt-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 ">
        <div className="pb-5 text-center flex flex-col items-center">
          ...
          <p className="text-gray-300">
            ...
            nisi voluptate quaerat nulla qui quos libero corporis voluptas
          ...
          <div className="text-center">
            ...
            <ul>
              <li>
                <a
                  href="#"
                  className="text-sm text-white hover:text-emerald-600"
                >
                  Home
                </a>
              </li>
      ...
      <div className="text-center pt-5">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} All Rights Reserved by SellPoint
        </p>
      </div>
    </footer>
  );
