...
const AttributeValue = ({ categoryDetails, searchData, allBrands }) => {
  const [isDrawerOpen, setIsDrawerOpen] = useState(false);
  const [isAddAttributeValueOpen, setIsAddAttributeValueOpen] = useState(false);
  ...
  // Function to open the Add AttributeValue modal
  const openAddAttributeValue = () => {
    setIsAddAttributeValueOpen(true);
  };
  // Function to close the Add Brand modal
  const closeAddAttributeValue = () => {
    setIsAddAttributeValueOpen(false);
  };
      ...
      <div className="min-h-screen flex flex-col sm:flex-row">
        ...
        <div className="w-full p-4">
          <div className="pb-2 flex justify-between">
            <div>
              <h2 className="text-2xl text-emerald-600">All Attribute Value</h2>
            </div>
            <div>
              {/* Brand Search start */}
            ...
            <div>
              <button
                onClick={openAddAttributeValue}
                className="primary-button dark:text-black flex justify-center items-center sm:text-base text-xs"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            {isAddAttributeValueOpen && (
              <AddAttributeValue onClose={closeAddAttributeValue} />
            )}
          </div>
          <div className="flex flex-wrap items-center justify-center">
            <h4 className="px-6 py-4 text-lg text-emerald-500 border-b border-emerald-200 pb-1">
              AttributeValue Name(Fetch from api)
            </h4>
          </div>
              ...
              <div className="inline-block min-w-full py-2">
                <div className="overflow-hidden">
                    ...
                    <thead className="border-b font-medium dark:border-emerald-500">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-4">
                          ...
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="icon icon-tabler icon-tabler-settings inline-block ml-1"
                            width="15"
                            height="15"
                            viewBox="0 0 24 24"
                            strokeWidth="2"
                      ...
                      {paginatedBrands &&
                        paginatedBrands?.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="whitespace-nowrap px-4 py-4 flex justify-center gap-1">
                              <a
                                href=""
                  ...
                  <ReactPaginate
                    ...
                    containerClassName={
                      "flex justify-end items-center gap-x-1 my-8"
                    }
                    pageLinkClassName={
                      "px-3 py-1 rounded-md dark:text-white text-black transition-all duration-300 border border-gray-400"
                    }
                    activeClassName={
                      "bg-emerald-500 text-white  px-0 py-1 rounded-md transition-all duration-300 hover:bg-emerald-600"
                    }
                    previousClassName={
                      "bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 px-3 py-1 rounded-md transition-all duration-300"
                    }
                    nextClassName={
                      "bg-gray-200 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 px-3 py-1 rounded-md mx-1 transition-all duration-300"
                    }
                    disabledClassName={
                      "text-gray-400 dark:text-gray-600 px-3 py-1 rounded-md cursor-not-allowed"
                    }
                  />
