...
const Allproducts = ({ productDetails, categoryDetails, searchData }) => {
  ...
  const currentProducts = productDetails
                          ...
                          <td className="whitespace-nowrap px-6 py-4 ">
                            <a href="" className="dark:text-white" title="Edit">
                              <svg
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="w-4 h-4 hover:text-emerald-600 transition inline-block mx-1"
                              >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                            ...
                            <button title="Delete">
                              <svg
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="w-4 h-4 hover:text-red-600 transition inline-block mx-1"
                              >
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
