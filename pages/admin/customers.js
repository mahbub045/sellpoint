          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto md:col-span-3">
              <table className="min-w-full">
                <thead>
                  <tr>
                    <th className="border border-emerald-400 px-5 text-center text-emerald-500">
                      Full Name
                    </th>
                    <th className="border border-emerald-400 px-5 text-center text-emerald-500">
                      Phone
                ...
                <tbody>
                  {formValues.map((value, index) => (
                    <tr key={index}>
                      <td className="border border-emerald-400 p-5 text-center">
                        {value.fullName}
                      </td>
                      <td className="border border-emerald-400 p-5 text-center">
                        {value.phone}
                      ...
                      <td className="border border-emerald-400 p-5">
                        <a
                          ...
                          className="dark:text-white hover:dark:text-red-600 hover:text-red-600 flex justify-center items-center cursor-pointer"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
