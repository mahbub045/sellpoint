...
const Attributes = ({ categoryDetails, searchData, allBrands }) => {
      ...
      <div className="min-h-screen flex flex-col sm:flex-row">
        ...
        <div className="w-full p-4">
          <div className="pb-2 flex justify-between">
            <div>
              <h2 className="text-2xl text-emerald-600">All Attribute</h2>
            </div>
            <div>
              {/* Brand Search start */}
            ...
            <div>
              <button
                ...
                className="primary-button dark:text-black flex items-center sm:text-base text-xs"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            {isAddAttributeOpen && <AddAttribute onClose={closeAddAttribute} />}
          </div>
                      ...
                      {paginatedBrands &&
                        paginatedBrands?.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="whitespace-nowrap px-6 py-4 grid grid-cols-4 gap-1">
                              <span className="bg-slate-300 dark:bg-slate-500 text-black  rounded px-1 py-[2px]">
                                {item.brandSlug}
                              </span>
                              <span className="bg-slate-300 dark:bg-slate-500 text-black  rounded px-1 py-[2px]">
                                {item.brandSlug}
                            ...
                            <td className="whitespace-nowrap px-6 py-4">
                              <button
                                title="Delete"
                                className="p-1 rounded-lg text-red-500 hover:text-white hover:bg-red-600 transition"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
