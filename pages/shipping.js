        ...
        <>
            ...
            <div className="container mx-auto px-4 py-2">
                ...
                <form className="max-w-screen-md mx-auto bg-slate-100 dark:bg-slate-950 px-4 py-2 shadow-md shadow-emerald-600 rounded-md" onSubmit={handleSubmit(submitHandler)}>
                    <h2 className="sm:text-xl text-base text-emerald-600 font-medium text-center">Shipping Address</h2>
                    <p className="sm:text-base text-sm mb-4 text-center">If needed, you can change your delivery information.</p>

                    {/* -------------------name and phone---------------------- */}
                    <div className="grid sm:grid-cols-2 grid-cols-1 gap-3 mb-4">
                        {/* name */}
                        <div>
                            <label className="sm:text-base text-sm text-emerald-600 font-semibold" htmlFor="fullName">Full Name*</label>
                            <input className="w-full px-3 py-2 text-emerald-700 bg-white border-emerald-200 rounded-md focus:border-emerald-400 focus:ring-emerald-300 focus:outline-none focus:ring focus:ring-opacity-40 sm:text-base text-xs" id="fullName" placeholder="Please enter full name" autoFocus
                                {...register("fullName", {
                        ...
                        {/* phone */}
                        <div>
                            <label className="sm:text-base text-sm text-emerald-600 font-semibold" htmlFor="phone">Phone Number*</label>
                            <input className="w-full px-3 py-2 text-emerald-700 bg-white border-emerald-200 rounded-md focus:border-emerald-400 focus:ring-emerald-300 focus:outline-none focus:ring focus:ring-opacity-40 sm:text-base text-xs" id="phone" placeholder="Please enter your active phone number!" autoFocus
                                {...register("phone", {
                    ...
                    {/* Address */}
                    <div className="mb-4">
                        <label className="sm:text-base text-sm text-emerald-600 font-semibold" htmlFor="address">Address*</label>
                        <textarea className="w-full px-3 py-2 text-emerald-700 bg-white border-emerald-200 rounded-md focus:border-emerald-400 focus:ring-emerald-300 focus:outline-none focus:ring focus:ring-opacity-40 sm:text-base text-xs" id="address" placeholder="Please enter details address!" autoFocus
                            {...register("address", {
                    ...
                    <div className="grid grid-cols-2 gap-5 mb-4">
                        {/* Division */}
                        <div>
                            <label className="sm:text-base text-sm text-emerald-600 font-semibold" htmlFor="division">Division*</label>
                            <select
                        ...
                        {/* District */}
                        <div>
                            <label className="sm:text-base text-sm text-emerald-600 font-semibold" htmlFor="district">District*</label>
                            <select
                                className="w-full px-3 py-2 text-emerald-700 bg-white border-emerald-200 rounded-md focus:border-emerald-400 focus:ring-emerald-300 focus:outline-none focus:ring focus:ring-opacity-40 sm:text-base text-xs"
                                id="district"
                                {...register("district", {
